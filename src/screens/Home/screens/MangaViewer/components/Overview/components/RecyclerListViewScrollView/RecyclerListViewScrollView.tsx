import { RecyclerListViewScrollViewProps } from '@screens/Home/screens/MangaViewer/components/Overview/components/RecyclerListViewScrollView/RecyclerListViewScrollView.interfaces';

...
import { toggleBoldTitles, adjustColumns, adjustTitleSize, changeCoverStyle } from '@redux/reducers/settingsReducer';
...
const connector = connect(mapStateToProps, { toggleBoldTitles, adjustColumns, adjustTitleSize, changeCoverStyle });

import { digitsOnly, extractChapterTitle, GENRES, getV3URL, getV5URL, parseTimestamp } from './MangaPark_v3.helpers';
import {
...
import { Manga, MangaChapter, MangaMultilingualChapter } from '../scraper/scraper.interfaces';

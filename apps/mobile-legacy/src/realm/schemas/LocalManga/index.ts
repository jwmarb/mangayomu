...
> {
  ...
  static schema: Realm.ObjectSchema = {
    ...
    properties: {
      ...
      source: 'string',
      description: 'mixed',
      genres: { type: 'set', objectType: 'string' },
      chapters: { type: 'list', objectType: 'string' },
      authors: { type: 'list', objectType: 'string', default: [] },
      isHentai: { type: 'bool', default: false },
      rating: 'MangaRating?',
      status: 'MangaStatus?',
      availableLanguages: { type: 'list', objectType: 'string' },
